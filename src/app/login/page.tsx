...
import { Sparkles, Mail, Lock, ArrowRight, ShieldCheck, Globe } from "lucide-react";
      ...
      >
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-zinc-500 dark:text-zinc-400">
            Sign in to access your cloud documents & e-Signatures
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              <a href="#" className="text-[11px] text-violet-500 hover:underline">
                Forgot password?
              </a>
            </div>
            <div className="relative">
        ...
        <div className="text-center space-y-3 pt-2">
          <p className="text-xs text-zinc-500">
            ...
            <Link href="/signup" className="text-violet-500 font-bold hover:underline">
              Create one for free
            </Link>
          </p>
