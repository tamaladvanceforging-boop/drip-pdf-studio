        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            <motion.div
              ...
              className="inline-flex items-center space-x-2 px-3.5 py-1.5 rounded-full bg-violet-500/10 border border-violet-500/30 text-violet-300 text-xs font-semibold shadow-lg shadow-violet-500/10"
            >
              <Sparkles className="w-4 h-4 text-violet-400 animate-pulse" />
              <span>Hybrid Web Native Adobe Reader + iLovePDF Suite</span>
            </motion.div>
            ...
            >
              Experience seamless Adobe Acrobat Reader Pro interactive viewing, freehand drawing, highlights, digital e-signatures, plus all 20+ iLovePDF tools. **100% private in browser memory** with zero cloud uploads.
            </motion.p>
            ...
            <div className="pt-4 flex flex-wrap items-center justify-center lg:justify-start gap-6 text-xs text-zinc-400">
              ...
              <span className="flex items-center space-x-1.5">
                ...
                <span>Touch & Stylus Ready</span>
              </span>
              <span className="flex items-center space-x-1.5">
                <CheckCircle2 className="w-4 h-4 text-fuchsia-400" />
                <span>Cross-Device PWA</span>
              </span>
            </div>
          </div>
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <BentoGrid>
          ...
          <BentoGridItem
            ...
            badge="e-Sign"
            onClick={() => (window.location.href = "/reader?tab=sign")}
          />
          ...
          <BentoGridItem
            ...
            header={
              <div className="flex flex-col items-center justify-center p-4 space-y-2 text-amber-400">
                ...
                <span className="text-xs font-bold text-zinc-300">Range & Bulk Extract</span>
              </div>
            }
          ...
          <BentoGridItem
            ...
            header={
              <div className="flex flex-col items-center justify-center p-4 space-y-2 text-purple-400">
                <Stamp className="w-10 h-10" />
                <span className="text-xs font-bold text-zinc-300">Stamps & Numbering</span>
              </div>
            }
          ...
          <BentoGridItem
            ...
            header={
              <div className="flex flex-col items-center justify-center p-4 space-y-2 text-teal-400">
                <ShieldCheck className="w-10 h-10" />
                <span className="text-xs font-bold text-zinc-300">Flatten & Protect</span>
              </div>
            }
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 border-t border-white/5">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="glass-card p-6 rounded-2xl space-y-3">
            ...
            <h3 className="font-bold text-zinc-100 text-base">100% Private & Local</h3>
          ...
          <div className="glass-card p-6 rounded-2xl space-y-3">
            ...
            <h3 className="font-bold text-zinc-100 text-base">Zero Upload Latency</h3>
            <p className="text-xs text-zinc-400 leading-relaxed">
          ...
          <div className="glass-card p-6 rounded-2xl space-y-3">
            ...
            <h3 className="font-bold text-zinc-100 text-base">Hybrid 3-Device Native</h3>
            <p className="text-xs text-zinc-400 leading-relaxed">
